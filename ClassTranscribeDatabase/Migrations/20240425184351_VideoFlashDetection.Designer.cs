...
namespace ClassTranscribeDatabase.Migrations
{
    ...
    [Migration("20240425184351_VideoFlashDetection")]
    partial class VideoFlashDetection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassTranscribeDatabase.Models.Video", b =>
                {
                    ...
                    b.Property<string>("FlashDetectionDataId")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ProcessedASLVideoId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ASLVideoId");

                    b.HasIndex("AudioId");

                    b.HasIndex("ProcessedASLVideoId");
            ...
            modelBuilder.Entity("ClassTranscribeDatabase.Models.Video", b =>
                {
                    b.HasOne("ClassTranscribeDatabase.Models.FileRecord", "ASLVideo")
                        .WithMany()
                        .HasForeignKey("ASLVideoId");

                    b.HasOne("ClassTranscribeDatabase.Models.FileRecord", "Audio")
                        .WithMany()
                        .HasForeignKey("AudioId");

                    b.HasOne("ClassTranscribeDatabase.Models.FileRecord", "ProcessedASLVideo")
                        .WithMany()
                        .HasForeignKey("ProcessedASLVideoId");
                    ...
                    b.Navigation("ASLVideo");

                    b.Navigation("Audio");

                    b.Navigation("ProcessedASLVideo");

                    b.Navigation("ProcessedVideo1");

                    b.Navigation("ProcessedVideo2");
